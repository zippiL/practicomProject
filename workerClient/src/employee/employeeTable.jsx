...
const EmployeeTable = ({ rows }) => {
    ...
    const columns = [
        ...
        { name: 'roles', label: 'Roles', options: { display: 'excluded' } },
        {
            ...
            options: {
                customBodyRenderLite: (index) => (
                    <IconButton onClick={() => handleEditClick(rows[index])}><EditIcon /></IconButton>
                ),
            },
        },
        {
            ...
            options: {
                customBodyRenderLite: (index) => (
                    <IconButton onClick={() => handleDeleteClick(rows[index].id)}><DeleteIcon /></IconButton>
                ),
            },
        },
    ];
                                    ...
                                    <TableBody>
                                        {roles.map((role) => (
                                            <TableRow key={role.id}>
                                                <TableCell>{rolesData.find((r) => r.id === role.tagRoleId)?.name}</TableCell>
                                                <TableCell>{role.isAdministrative ? <CheckIcon /> : <ClearIcon />}</TableCell>
    ...
    return (
        <div>
            ...
            <DeleteEmployee handleClose={handleCloseDelete} open={displayDelete} id={selectedEmployeeId} />
